...
class TestTutorInitialization:
    ...
    def test_helpful_tutor_initialization(self, helpful_tutor: Tutor) -> None:
    ...
    def test_unhelpful_tutor_initialization(self, unhelpful_tutor: Tutor) -> None:
    ...
    def test_tutor_has_practice_item_pool(self, helpful_tutor: Tutor, practice_item_pool: PracticeItemPool) -> None:
...
class TestTutorBehavior:
    ...
    def test_tutor_response_mode(self, helpful_tutor: Tutor) -> None:
        """Test that tutor has correct response interaction mode."""
        assert helpful_tutor.response_interaction_mode == "return_only"

    def test_tutor_characteristics_stored(self, helpful_tutor: Tutor, unhelpful_tutor: Tutor) -> None:
        ...
        assert helpful_tutor.tutor_characteristics != unhelpful_tutor.tutor_characteristics
